...
int at86rf231_initialize(netdev_t *dev)
{
    ...
    radio_address_long = NTOHLL(radio_address_long);
    radio_address = NTOHS(radio_address);
    return 0;
}
...
uint64_t at86rf231_set_address_long(uint64_t address)
{
    ...
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_0, (uint8_t)(0x00000000000000FF & HTONLL(radio_address_long)));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_1, (uint8_t)(0x000000000000FF00 & HTONLL(radio_address_long) >> 8));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_2, (uint8_t)(0x0000000000FF0000 & HTONLL(radio_address_long) >> 16));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_3, (uint8_t)(0x00000000FF000000 & HTONLL(radio_address_long) >> 24));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_4, (uint8_t)(0x000000FF00000000 & HTONLL(radio_address_long) >> 32));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_5, (uint8_t)(0x0000FF0000000000 & HTONLL(radio_address_long) >> 40));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_6, (uint8_t)(0x00FF000000000000 & HTONLL(radio_address_long) >> 48));
    at86rf231_reg_write(AT86RF231_REG__IEEE_ADDR_7, (uint8_t)(HTONLL(radio_address_long) >> 56));
